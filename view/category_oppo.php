...
//phan trang
$sql="select count(id) as number from product where category = 'OP' ";
...
if(isset($_GET['s']) && $_GET['s']!=''){
  $sql_list = 'select * from product where product_name like "%'.$_GET['s'].'%" and category = "OP" ';
}
else{
  $sql_list = "select * from product where category = 'OP'  limit $index , 10 ";
}
