...
//phan trang
$sql="select count(id) as number from product where category = 'IP' ";
...
if(isset($_GET['s']) && $_GET['s']!=''){
  $sql_list = 'select * from product where product_name like "%'.$_GET['s'].'%" and category = "IP" ';
}
else{
  $sql_list = "select * from product where category = 'IP'  limit $index , 10 ";
}
